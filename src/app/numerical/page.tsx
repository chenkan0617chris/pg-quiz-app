...
export default function NumericalPage() {
  ...
  const solve = () => {
    const [min, max] = range === '1-9' ? [1, 9] : [0, 9];
    setResult(solveNumeric(tokens, parseFloat(target), { min, max, distinct }));
  };
  ...
  return (
    <div className="w-full">
      ...
      <header className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight text-gray-900">{t('numTitle')}</h1>
        <p className="mt-2 text-gray-500">{t('numSubtitle')}</p>
      </header>
